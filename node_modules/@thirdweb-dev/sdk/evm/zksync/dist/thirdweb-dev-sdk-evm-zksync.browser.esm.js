...
import { aN as fetchAndCacheDeployMetadata, a5 as extractConstructorParamsFromAbi } from '../../../dist/index-9cc349f9.browser.esm.js';
import { e as extractFunctionParamsFromAbi, s as convertParamValues, T as ThirdwebSDK } from '../../../dist/sdk-e8270ceb.browser.esm.js';
...
import '../../../dist/contract-publisher-9d02c6c1.browser.esm.js';
import '@thirdweb-dev/contracts-js/dist/abis/ContractPublisher.json';
import '../../../dist/transactions-fabee9a8.browser.esm.js';
import '@thirdweb-dev/contracts-js/dist/abis/TWMultichainRegistryLogic.json';
import '@thirdweb-dev/contracts-js/dist/abis/TWMultichainRegistryRouter.json';
import '../../../dist/fetchCurrencyValue-f52ab0b5.browser.esm.js';
import '../../../dist/normalizePriceValue-eb4a62fc.browser.esm.js';
import '@thirdweb-dev/generated-abis';
import '../../../dist/deployWithThrowawayDeployer-8434ff4a.browser.esm.js';
...
function zkGetDefaultTrustedForwarders(chainId, contractName) {
  const biconomyForwarder = CONTRACT_ADDRESSES[chainId]?.biconomyForwarder || AddressZero;
  const openzeppelinForwarder = CONTRACT_ADDRESSES[chainId]?.openzeppelinForwarder || AddressZero;
...
async function zkDeployContractFromUri(publishMetadataUri, constructorParamValues, signer, storage, chainId, options) {
  ...
  if (extendedMetadata && extendedMetadata.factoryDeploymentData && !forceDirectDeploy && (!extendedMetadata.deployType || extendedMetadata.deployType !== "standard")) {
    if (extendedMetadata.isDeployableViaProxy || extendedMetadata.isDeployableViaFactory || extendedMetadata.deployType === "autoFactory") {
      ...
      const encodedInitializer = Contract.getInterface(compilerMetadata.abi).encodeFunctionData(extendedMetadata.factoryDeploymentData.implementationInitializerFunction, paramValues);
...
export { CONTRACT_ADDRESSES, IMPLEMENTATIONS, getImplementation, getZkTransactionsForDeploy, zkDeployContractFromUri, zkGetDefaultTrustedForwarders };
