...
class Marketplace {
  ...
  async getActiveListings(filter) {
    ...
    return filtered.filter(l => {
      return l.type === marketplaceAuction.ListingType.Auction && ethers.BigNumber.from(l.endTimeInEpochSeconds).gt(now) && ethers.BigNumber.from(l.startTimeInEpochSeconds).lte(now) || l.type === marketplaceAuction.ListingType.Direct && ethers.BigNumber.from(l.quantity).gt(0);
    });
  }
