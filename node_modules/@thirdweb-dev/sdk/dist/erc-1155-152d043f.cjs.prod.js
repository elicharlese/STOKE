...
class DropErc1155ClaimConditions {
  ...
  async getClaimIneligibilityReasons(tokenId, quantity, addressToCheck) {
    ...
    try {
      ...
      if (index.includesErrorMessage(err, "!CONDITION") || index.includesErrorMessage(err, "no active mint condition")) {
...
class Erc1155 {
  ...
  airdrop = /* @__PURE__ */transactions.buildTransactionFunction((() => {
    ...
    return async function (tokenId, addresses, fromAddress) {
      let data = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [0];
      const from = fromAddress ? await index.resolveAddress(fromAddress) : await _this3.contractWrapper.getSignerAddress();
      ...
      const contractEncoder = new fetchCurrencyValue.ContractEncoder(_this3.contractWrapper);
