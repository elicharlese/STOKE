...
class ContractPublisher extends index.RPCConnectionHandler {
  ...
  publish = /* @__PURE__ */transactions.buildTransactionFunction(async (predeployUri, extraMetadata) => {
    ...
    const isPlugin = index.isFeatureEnabled(index.AbiSchema.parse(compilerMetadata.abi), "PluginRouter");
    const isDynamic = index.isFeatureEnabled(index.AbiSchema.parse(compilerMetadata.abi), "DynamicContract");
