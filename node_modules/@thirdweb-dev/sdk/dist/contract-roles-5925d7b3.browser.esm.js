...
import { d3 as FEATURE_PERMISSIONS, H as getRoleHash, aP as resolveAddress, o as MissingRoleError } from './index-9cc349f9.browser.esm.js';
...
class ContractRoles {
  ...
  setAll = /* @__PURE__ */buildTransactionFunction(async rolesWithAddresses => {
    ...
    for (let i = 0; i < sortedRoles.length; i++) {
      ...
      const connectedWalletAddress = await this.contractWrapper.getSignerAddress();
