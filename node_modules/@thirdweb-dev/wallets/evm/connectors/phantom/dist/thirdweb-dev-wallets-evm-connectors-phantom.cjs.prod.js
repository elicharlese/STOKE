...
class PhantomConnector extends evm_connectors_injected_dist_thirdwebDevWalletsEvmConnectorsInjected.InjectedConnector {
  constructor(arg) {
    const defaultOptions = {
      name: "Phantom",
      shimDisconnect: true,
      shimChainChangedDisconnect: true,
      getProvider: getInjectedPhantomProvider.getInjectedPhantomProvider
    };
    const options = {
      ...defaultOptions,
      ...arg.options
    ...
    defineProperty._defineProperty(this, "id", walletIds.walletIds.phantom);
