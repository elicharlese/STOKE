...
class CoreWalletConnector extends evm_connectors_injected_dist_thirdwebDevWalletsEvmConnectorsInjected.InjectedConnector {
  constructor(arg) {
    const defaultOptions = {
      name: "Core Wallet",
      shimDisconnect: true,
      shimChainChangedDisconnect: true,
      getProvider: getInjectedCoreWalletProvider.getInjectedCoreWalletProvider
    };
    const options = {
      ...defaultOptions,
      ...arg.options
    ...
    defineProperty._defineProperty(this, "id", walletIds.walletIds.coreWallet);
  }
...
exports.CoreWalletConnector = CoreWalletConnector;
