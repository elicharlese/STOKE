...
require('../../../../dist/assertWindowEthereum-318e6f2d.cjs.prod.js');
require('../../../../dist/url-f55506f3.cjs.prod.js');
require('../../../../dist/normalizeChainId-dc975fa1.cjs.prod.js');

class CryptoDefiWalletConnector extends evm_connectors_injected_dist_thirdwebDevWalletsEvmConnectorsInjected.InjectedConnector {
  constructor(arg) {
    const defaultOptions = {
      name: "Crypto Defi Wallet",
      shimDisconnect: true,
      shimChainChangedDisconnect: true,
      getProvider: getInjectedCryptoDefiWalletProvider.getInjectedCryptoDefiWalletProvider
    };
    const options = {
      ...defaultOptions,
      ...arg.options
    ...
    defineProperty._defineProperty(this, "id", walletIds.walletIds.cryptoDefiWallet);
  }
...
exports.CryptoDefiWalletConnector = CryptoDefiWalletConnector;
