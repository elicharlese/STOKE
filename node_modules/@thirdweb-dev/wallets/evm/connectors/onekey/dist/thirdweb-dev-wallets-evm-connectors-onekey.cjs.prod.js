...
class OneKeyConnector extends evm_connectors_injected_dist_thirdwebDevWalletsEvmConnectorsInjected.InjectedConnector {
  constructor(arg) {
    const defaultOptions = {
      name: "OneKey Wallet",
      shimDisconnect: true,
      shimChainChangedDisconnect: true,
      getProvider: getInjectedOneKeyProvider.getInjectedOneKeyProvider
    };
    const options = {
      ...defaultOptions,
      ...arg.options
    ...
    defineProperty._defineProperty(this, "id", walletIds.walletIds.oneKey);
  }
