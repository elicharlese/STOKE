...
class OKXConnector extends evm_connectors_injected_dist_thirdwebDevWalletsEvmConnectorsInjected.InjectedConnector {
  constructor(arg) {
    const defaultOptions = {
      name: "OKX",
      shimDisconnect: true,
      shimChainChangedDisconnect: true,
      getProvider: getInjectedOKXProvider.getInjectedOKXProvider
    };
    const options = {
      ...defaultOptions,
      ...arg.options
    ...
    defineProperty._defineProperty(this, "id", walletIds.walletIds.okx);
  }
